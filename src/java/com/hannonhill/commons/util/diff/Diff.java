/*
 * Created on December 11, 2006 by Zach Bailey
 */
package com.hannonhill.commons.util.diff;
...
public class Diff<T>
{
     ...
     * comparator.
     */
    public Diff(Collection<T> a, Collection<T> b, Comparator<T> comp)
    {
        this((T[]) a.toArray(), (T[]) b.toArray(), comp);
    }
     ...
     * <code>compareTo</code>.
     */
    public Diff(Collection<T> a, Collection<T> b)
    {
        this(a, b, null);
    }
